...
public class SettingRepositoryTest {
	...
	public void testCreateGeneralSettings() {
		//Setting siteName = new Setting("SITE_NAME", "Grp3Project", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Clothing.png", SettingCategory.GENERAL);
		//Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2022 Grp3Project Ltd.", SettingCategory.GENERAL);
		
		repo.saveAll(List.of(siteLogo));
